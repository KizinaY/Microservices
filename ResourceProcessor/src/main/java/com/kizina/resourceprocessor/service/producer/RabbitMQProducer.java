package com.kizina.resourceprocessor.service.producer;
...
public class RabbitMQProducer {
    ...
    public void sendMessage(String message) {
        ...
        rabbitTemplate.convertAndSend(PROCESSING_QUEUE_NAME, messageWithTraceId);
        log.info("Message with processed resourceId: " + message + " was send to queue.");
    }
